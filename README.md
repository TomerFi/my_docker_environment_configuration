...
| ---------------- | --------- | -------------- | -------- | --------------------- |
| `docker_station` | `Manager` | `19.03.4`      | `x86_64` | `Ubuntu 18.04.2`      |
| `haserver`       | `Worker`  | `19.03.4`      | `armv71` | `Raspbian buster 10 ` |
| `docker-desktop` | `Worker`  | `19.03.4`      | `x86_64` | `Windows 10 Pro`      |
